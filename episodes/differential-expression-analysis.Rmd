...
count_tpose <-  counts  %>%
                ...
                pivot_longer(., cols = -"gene_id",
                  names_to = "specimenID",  values_to="counts") %>%
                as.data.frame() %>%
...
count_tpose$timepoint <- 
  factor(count_tpose$timepoint,levels=c("4 mo","6 mo","12 mo"))
...
First, order the data (so counts and metadata specimenID orders match) and save 
as another variable name.
